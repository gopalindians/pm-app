        ...
        <tr>
            <td align="center" bgcolor="#eff3f8">
                                                                ...
                                                                <td align="left" valign="top" class="mob_center">
                                                                    <a href="#" target="_blank"
                                                                       style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                                                        <span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; font-size: small; color: #596167; ">
				...
				Item -->
                                                                                ...
                                                                                <td width="30" align="center"
                                                                                    ...
                                                                                    <a href="#" target="_blank"
                                                                                       style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                                        <span style="font-family: Arial, Helvetica, sans-serif; font-size: x-small; color: #596167; ">
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <div style="line-height: 44px;">
                                            {{--<span style="font-family: Arial, Helvetica, sans-serif; font-size: large; color: #57697e; ">--}}
                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff"
                            style="border-bottom: 1px solid #eff2f4;">
